...
func handleResponse(s io.ReadCloser) {
	...
	column_1 := "%-15s%-15s%-15s%-20s\n"
	column_2 := "%-15.2f%-15.2f%-15.2f%-20s\n\n"

	fmt.Printf(column_1, "Current temp", "Today's high", "Today's low", "Condition")
	fmt.Printf(column_2, f.Main.Temp, f.Main.Temp_Max, f.Main.Temp_Min, f.Weather[0].Description)
}
